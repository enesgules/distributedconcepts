...
Interactive 3D learning platform for distributed database concepts — replication, consistency, and failover.
...
- **Data:** All simulated client-side (no real database connection)
