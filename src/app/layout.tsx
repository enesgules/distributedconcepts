      ...
      >
        ...
        <div className="fixed right-3 top-3 md:right-5 md:top-5 z-30 flex items-center gap-2">
          <a
            ...
            className="flex h-11 w-11 md:h-8 md:w-8 items-center justify-center rounded-full border border-zinc-800 bg-zinc-950/80 text-zinc-500 backdrop-blur-sm transition-colors hover:border-zinc-700 hover:text-zinc-300"
          >
